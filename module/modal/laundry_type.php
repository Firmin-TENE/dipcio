	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Création d'un nouveau type de document</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" role="form" id="form-type">
				  ...
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">libellé :</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="type" placeholder="Exemple: Relevé de notes, diplôme, ..." required>
				    </div>
				  </div>
				  <!--
				  <div class="form-group">
