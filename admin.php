...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <button id="newLexique" type="button" class="btn btn-success btn-sm"> 
                Ajouter
                <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
              </button>

              <button id="delLexique" type="button" class="btn btn-danger btn-sm">
                Supprimer
    ...
    <?php include_once('module/modal/mod_lexique.php'); ?>
